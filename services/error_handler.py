...
class ErrorHandler:
    ...
    def log_error(self, error: Exception, context: Optional[Dict[str, Any]] = None, level: int = logging.ERROR) -> None:
        """
...
def handle_error(
    ...
    return error_handler.handle_error(
        error=error, context=context, include_details=include_details, error_code=error_code, log_level=log_level
    )
