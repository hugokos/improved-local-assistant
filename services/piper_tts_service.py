...
class PiperTTSService:
        ...
        try:
            ...
            if hasattr(self.voice, 'config'):
                ...
                if hasattr(self.voice.config, 'audio'):
                    self.sample_rate = getattr(self.voice.config.audio, 'sample_rate', self.sample_rate)
    ...
    async def synthesize_stream(self, text: str, session_id: str = None) -> AsyncGenerator[bytes, None]:
        """
    ...
    async def synthesize_to_file(self, text: str, output_path: Path) -> bool:
        ...
        try:
            ...
            await loop.run_in_executor(
                None,
                self._synthesize_to_file_blocking,
                text,
                output_path
            )
