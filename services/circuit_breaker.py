    ...
    async def execute(self, func: Callable[..., Awaitable[T]], *args, **kwargs) -> T:
        ...
        async with self._lock:
            ...
            if self.state == CircuitState.HALF_OPEN and self.half_open_calls >= self.half_open_max_calls:
                ...
                raise CircuitBreakerOpenError(f"Circuit breaker '{self.name}' exceeded half-open call limit")
...
async def with_circuit_breaker(
    ...
    **kwargs,
    ...
    Raises:
        ...
        Exception: Any exception raised by the function
    """
    cb = await registry.get_or_create(name=name, failure_threshold=failure_threshold, recovery_timeout=recovery_timeout)
