...
class WorkingSetCache:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self._max_total_nodes = (self.global_memory_limit_mb * 1024 * 1024) // 1024  # Rough estimate
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Working Set Cache initialized with {len(self._session_caches)} sessions")
    ...
    async def get_neighborhood(
        ...
        try:
            ...
            self.logger.debug(f"Getting neighborhood for {len(node_ids)} nodes (max {max_edges} edges)")
    ...
    async def _maybe_evict_sessions(self) -> None:
        ...
        self.logger.info(f"Global cache limit reached ({self._total_cached_nodes} nodes), evicting sessions")
        ...
        target_nodes = int(self._max_total_nodes * self.eviction_threshold * 0.8)  # 80% of threshold
    ...
    async def _load_cache(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Loaded cache from disk: {len(self._session_caches)} sessions, "
    ...
    def get_global_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_utilization": self._total_cached_nodes / self._max_total_nodes if self._max_total_nodes > 0 else 0,
            "metrics": self.metrics.copy()
        }
