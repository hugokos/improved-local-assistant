...
class ConversationSummarizer:
    ...
    async def summarize_conversation(self, messages: List[Dict[str, Any]], max_messages: int = 20) -> str:
        """
    ...
    async def compress_conversation(
        ...
        compressed = [
            {"role": "system", "content": f"Previous conversation summary: {summary}", "timestamp": datetime.now()}
        ]
