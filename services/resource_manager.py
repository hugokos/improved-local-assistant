    ...
    async def _monitoring_loop(self) -> None:
        ...
        while self.is_monitoring:
            try:
                ...
                if self.metrics["last_cleanup_time"] is None or current_time - self.metrics["last_cleanup_time"] > 300:
            ...
            if kg_manager.dynamic_kg:
                try:
                    ...
                    if node_count > max_nodes:
                        ...
                        storage_ctx = kg_manager.dynamic_kg._storage_context.__class__.from_defaults(
                        ...
                        important_nodes = sorted(G.degree, key=lambda x: x[1], reverse=True)[:max_nodes]
