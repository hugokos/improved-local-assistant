    ...
    async def initialize_kg_manager(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                if loaded_graphs:
                    print(f"✅ Knowledge graph initialized with {len(loaded_graphs)} prebuilt graphs")
                else:
                    ...
                    if citations_data and citations_data.get("citations"):
                        ...
                        if citations:
                            ...
                            for citation in citations:
                                ...
                                if metadata:
                                    file_info = metadata.get("file_name") or metadata.get("file_path") or metadata.get("document_id")
                                    if file_info:
...
async def main():
    ...
    parser.add_argument(
        "--no-kg",
        action="store_true",
        help="Disable knowledge graph for pure chat mode"
    )
