...
def suggest_system_optimizations():
    ...
    if memory_info["available_gb"] < 2:
        ...
        logger.info("   - Using the optimized config: python run_app.py --config config_optimized.yaml")
...
def main():
    ...
    logger.info(f"💾 Initial Memory: {initial_memory['available_gb']:.1f}GB available "
    ...
    logger.info(f"💾 Final Memory: {final_memory['available_gb']:.1f}GB available "
