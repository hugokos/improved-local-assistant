...
class ModelBenchmark:
                ...
                if result.returncode == 0 and "Metal" in result.stdout:
                    ...
                    for line in lines:
                        ...
                        if "Chipset Model:" in line:
                            ...
                            if "GB" in vram_str:
                                current_gpu["memory_total_mb"] = int(
                                    float(vram_str.split()[0]) * 1024
                                )
                            elif "MB" in vram_str:
    ...
    def print_hardware_summary(self):
        ...
        print(
            f"  System: {system.get('system', 'Unknown')} {system.get('release', '')} ({system.get('machine', '')})"
        )
        ...
        print(
            f"  Memory: {total_gb} GB total, {available_gb} GB available ({used_percent:.1f}% used)"
        )
