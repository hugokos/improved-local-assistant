...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("install.log", mode="w")],
)
logger = logging.getLogger(__name__)

# Define required directories
REQUIRED_DIRS = ["logs", "data", "data/prebuilt_graphs", "data/dynamic_graph", "data/sessions"]
...
OPTIONAL_PACKAGES = ["pytest", "httpx", "websockets"]
...
def install_dependencies(include_optional: bool = False) -> bool:
    ...
    try:
        ...
        if sys.platform == "win32":
            ...
            try:
                subprocess.run([pip_path, "install", "pywin32>=306"], check=True)
    ...
    try:
        ...
        config = {
            ...
            "environment_production": {
                "api": {"cors_origins": ["http://localhost:8000"]},
                "system": {"memory_threshold_percent": 70, "cpu_threshold_percent": 70},
            },
        }
...
def main():
    ...
    parser.add_argument(
        "--with-optional", action="store_true", help="Install optional dependencies"
    )
