...
class ModelManager:
    ...
    def __init__(self, host: str = "http://localhost:11434"):
        ...
        self.chat_llm = Ollama(model=self.conversation_model, base_url=host, request_timeout=120.0)

        self.kg_llm = Ollama(model=self.knowledge_model, base_url=host, request_timeout=60.0)
        ...
        try:
            ...
            Settings.embed_model = OllamaEmbedding(
                model_name="nomic-embed-text", base_url=host, request_timeout=60.0
            )
    ...
    async def query_knowledge_model(
        ...
        try:
            ...
            return {"content": f"Error: {str(e)}", "model": self.knowledge_model, "error": str(e)}
