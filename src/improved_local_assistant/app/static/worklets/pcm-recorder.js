...
class PCMRecorderProcessor extends AudioWorkletProcessor {
    ...
    sendVADFrame() {
        ...
        const bufferCopy = vadFrameData.buffer.slice(0);

        // Debug: Log message sending occasionally
        if (Math.random() < 0.02) { // Log ~2% of messages
            console.log('🔧 Worklet sending message:', {
                type: 'vad_frame',
                bufferSize: bufferCopy.byteLength,
